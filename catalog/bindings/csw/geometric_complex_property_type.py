...
from bindings.csw.composite_curve_type import CompositeCurve
from bindings.csw.composite_solid_type import CompositeSolid
from bindings.csw.composite_surface_type import CompositeSurface
...
class GeometricComplexPropertyType:
    """A property that has a geometric complex as its value domain can either
