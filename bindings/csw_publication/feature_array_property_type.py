...
from bindings.csw_publication.abstract_general_operation_parameter_ref_type import OperationParameterGroup
...
from bindings.csw_publication.geometry_array_property_type import MultiGeometry
...
from bindings.csw_publication.topo_complex_member_type import TopoComplex
...
@dataclass
class Subject2(TargetPropertyType):
...
class ObservationType(AbstractFeatureType):
    ...
    subject: Optional[Subject2] = field(
        default=None,
        metadata={
            "type": "Element",
            "namespace": "http://www.opengis.net/gml",
